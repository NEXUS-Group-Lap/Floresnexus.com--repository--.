...
const orbits: OrbitConfig[] = [
  {
    items: [
      ...
      { Icon: Smartphone, en: "Mobile", es: "Celular" },
      { Icon: Globe, en: "Online", es: "En línea" },
      { Icon: RefreshCw, en: "Updates", es: "Cambios" },
      { Icon: ImageIcon, en: "Photos", es: "Fotos" },
    ],
    duration: 30,
    reverse: false,
  },
  {
    items: [
      { Icon: Mail, en: "Contact", es: "Contacto" },
      { Icon: Share2, en: "Social", es: "Redes" },
      { Icon: MapPin, en: "Location", es: "Ubicación" },
      { Icon: Clock, en: "Hours", es: "Horario" },
      { Icon: Search, en: "Search", es: "Búsqueda" },
    ],
    duration: 40,
    reverse: true,
  },
  {
    items: [
      { Icon: Shield, en: "Security", es: "Seguridad" },
      { Icon: Languages, en: "EN/ES", es: "EN/ES" },
      { Icon: Palette, en: "Brand", es: "Marca" },
      { Icon: Server, en: "Active", es: "Activo" },
