...
export const plans: Record<string, Plan> = {
  ...
  starter: {
    ...
    en: {
      ...
      bestFor: "Small businesses that need a simple online presence.",
      homeFeatures: [
        "One complete page",
    ...
    es: {
      ...
      bestFor: "Pequeños negocios que necesitan una presencia online simple.",
      homeFeatures: [
        "Una página completa",
  ...
  professional: {
    ...
    en: {
      ...
      bestFor: "Businesses that need a stronger presentation with services, gallery, and contact form.",
      homeFeatures: [
        "Up to 5 pages",
    ...
    es: {
      ...
      bestFor: "Negocios que necesitan una presentación más sólida con servicios, galería y formulario de contacto.",
      homeFeatures: [
        "Hasta 5 páginas",
