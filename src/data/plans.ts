...
export const promoConfig = {
  ...
  en: {
    badge: "Launch Offer",
    title: "$0 Setup — Launch Offer",
    why: "We're just getting started and want to earn your trust. That's why we're waiving the setup fee for our first 30 clients.",
    detail: "Available for Nexus Card and Starter Website only. Professional Website is not included. Extras are not included. First month is paid at confirmation.",
    slots: "30 spots available — or while the offer lasts",
  },
  es: {
    badge: "Oferta de Lanzamiento",
    title: "$0 Inicial — Oferta de Lanzamiento",
    why: "Estamos comenzando y queremos ganarnos tu confianza. Por eso eliminamos el costo inicial para nuestros primeros 30 clientes.",
    detail: "Aplica para Nexus Card y Starter Website únicamente. Professional Website no está incluido. Extras no incluidos. El primer mes se paga al confirmar.",
    slots: "30 cupos disponibles — o hasta agotar la oferta",
  },
};
  ...
  "nexus-card": {
    ...
    en: {
      ...
      homeFeatures: [
        ...
        "Listed on the floresnexus.cards directory so customers can find you",
      ...
      includes: [
        ...
        "Logo + 1 main image",
        "Listed on the floresnexus.cards directory",
        "1 language (English or Spanish)",
    ...
    es: {
      ...
      homeFeatures: [
        ...
        "Apareces en el directorio floresnexus.cards para que los clientes te encuentren",
      ...
      includes: [
        ...
        "Apareces en el directorio floresnexus.cards",
        "1 idioma (inglés o español)",
